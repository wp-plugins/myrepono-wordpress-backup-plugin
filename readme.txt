...
The myRepono WordPress Backup Plugin is frequently and thoroughly tested with WordPress versions, 2.8, 2.9, 3.0, 3.1, 3.2, 3.3.x, 3.4.x, 3.5.x, 3.6.x, 3.7.x, 3.8.x, 3.9.x, 4.0.x, 4.1.x and 4.2.x.
