...
Tags: backup, wordpress backup, wp backup, back-up, restore, restoration, recover, recovery, remote, offline, online, offsite, website, web, site, web site, file, database, db, mysql, sql, automated, automatic, myrepono
...
Once installed, a 'myRepono Backup' option will be shown under the 'Settings' section of your administration panel.  Select this option and follow the on-screen instructions to complete the setup process.
