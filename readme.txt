...
Plugin will now automatically detect if a domain configuration has been removed via myRepono.com and will automatically default to an existing domain when possible.  Additional minor changes to optimise CSS.
