		...
		if ((isset($_POST['myrepono_databases'])) && (isset($_POST['myrepono_databases_remove']))) {
			...
			if (($input_databases_host!='') && ($input_databases_name!='') && ($input_databases_user!='')) {
				...
				if ($db_test = new wpdb($input_databases_user, $input_databases_pass, $input_databases_name, $input_databases_host)) {
					...
					if ($db_test_result = $db_test->get_results('show tables from `'.mysql_escape_string($input_databases_name).'`;', ARRAY_A )) {
...
<div id="col-container">
	...
	<div id="col-right">
		<div class="col-wrap">
			...
			<thead>
				<tr>
					<th scope="col" class="manage-column check-column" width="16"><input type="checkbox" name="myrepono_tables_all" onclick="myrepono_select_all('tables', this.checked);" /></th>
					<th scope="col" class="manage-column">Tables</th>
				</tr>
			</thead>
			<tbody>
			$tables
...
<div id="col-container">
	...
	<div id="col-right">
		<div class="col-wrap">
			...
			<thead>
				<tr>
					<th scope="col" class="manage-column check-column" width="16"><input type="checkbox" name="myrepono_databases_all" onclick="myrepono_select_all('databases', this.checked);" /></th>
					<th scope="col" class="manage-column">Host</th>
					<th scope="col" class="manage-column">Name</th>
					<th scope="col" class="manage-column">Username</th>
					<th scope="col" class="manage-column">Selected Tables</th>
				</tr>
			</thead>
			<tbody>
			$databases
