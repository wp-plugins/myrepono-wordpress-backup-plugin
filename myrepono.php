...
END;
		...
		if (($myrepono_array['myr_username']=="") || ($myrepono_array['myr_password']=="")) {
			...
			if ($myrepono_free_trial_topup_credit = myrepono_connect("http://myRepono.com/sys/free_trial_credit/")) {
