...
function myrepono_css() {
	...
	print <<<END
	<style type="text/css">
#myrepono_status{position:absolute;top:4.7em;margin:0;padding:4px;padding-left:8px;padding-right:8px;$x:215px;font-size:10px;z-index:2;background:#757575;color:#fff;-moz-border-radius:0 0 5px 5px;-webkit-border-radius:0 0 5px 5px;}#myrepono_status a{color:#fff;text-decoration:none;position:relative;top:-1px;}#myrepono_logo{padding:2px;border:1px solid #bbb;margin-left:10px;margin-right:10px;}.myrepono_response{border-width:1px;border-style:solid;padding:0 .6em;margin:5px 15px 2px;-moz-border-radius:3px;-khtml-border-radius:3px;-webkit-border-radius:3px;border-radius:3px;background-color:#ffffe0;border-color:#e6db55;}
	</style>
END;
