...
function myrepono_plugin_home_func() {
	...
	<tr>
		$backups_checkbox
		<td><img src="$icon_url/$backup_icon" width="16" height="16" alt="$backup_icon_txt" title="$backup_icon_txt" /></td>
...
END;
						...
						$backups[$backups_date] .= $backups_array[$backups_array_key];
...
END;
				...
				if ((isset($myrepono['papi']['permissions']['queue'])) && ($backups_select_domain==$myrepono_domain)) {
					$backups_checkbox = '<th scope="col" class="manage-column check-column" width="16"><input type="checkbox" name="myrepono_backups_all" onclick="myrepono_select_all(\'backups\', this.checked);" /></th>';
				}
...
<div id="col-container">
	<div class="col-wrap">
		...
		<thead>
			<tr>
				$backups_checkbox
				<th scope="col" class="manage-column" width="16"></th>
				<th scope="col" class="manage-column" width="120">Time</th>
				<th scope="col" class="manage-column" width="200">Profile Name</th>
				<th scope="col" class="manage-column" width="160">Location</th>
				<th scope="col" class="manage-column">Size</th>
				<th scope="col" class="manage-column" width="200">Actions</th>
			</tr>
		</thead>
		<tbody>
		$backups
...
<tr>
	...
	<td>$queue_message</td>
	$queue_now_separator
	<td width="100"  align="right">$queue_now</td>
</tr>
</table>
END;
