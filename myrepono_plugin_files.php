...
<div id="col-container">
	...
	<div id="col-right">
		<div class="col-wrap">
			...
			<thead>
				<tr>
					<th scope="col" class="manage-column check-column" width="16"><input type="checkbox" name="myrepono_files_all" onclick="myrepono_select_all('files', this.checked);" /></th>
					<th scope="col" class="manage-column">File/Directory Path</th>
				</tr>
			</thead>
			<tbody>
			$files
...
<div id="col-container">
	...
	<div id="col-right">
		<div class="col-wrap">
			...
			<thead>
				<tr>
					<th scope="col" class="manage-column check-column" width="16"><input type="checkbox" name="myrepono_excludes_all" onclick="myrepono_select_all('excludes', this.checked);" /></th>
					<th scope="col" class="manage-column">Exclusion Rule</th>
				</tr>
			</thead>
			<tbody>
			$excludes
